...
contract("Multivest", function(accounts) {
  ...
  it("set multivest & unset multivest", function() {
    ...
    return TestMultivest.new(accounts[1])
      ...
      .then(() =>
        instance.setAllowedMultivest(accounts[0], { from: accounts[1] })
      )
      .then(Utils.receiptShouldFailed)
      .catch(Utils.catchReceiptShouldFailed)
      .then(() => instance.allowedMultivests.call(accounts[0]))
      .then((result) =>
        assert.equal(result.valueOf(), false, "should be false")
      )
      ...
      .then(() =>
        instance.setAllowedMultivest(accounts[2], { from: accounts[1] })
      )
      .then(Utils.receiptShouldFailed)
      .catch(Utils.catchReceiptShouldFailed)
      ...
      .then(() =>
        instance.unsetAllowedMultivest(accounts[0], { from: accounts[1] })
      )
      .then(Utils.receiptShouldFailed)
      .catch(Utils.catchReceiptShouldFailed)
      .then(() => instance.allowedMultivests.call(accounts[0]))
      ...
      .then(() =>
        instance.unsetAllowedMultivest(accounts[2], { from: accounts[1] })
      )
      .then(Utils.receiptShouldFailed)
      .catch(Utils.catchReceiptShouldFailed)
      .then(() => instance.allowedMultivests.call(accounts[2]))
